...
Item {
    ...
    property bool radical2_correct : true
    property string radical2_character : "较"
    property string radical2_pinyin : "Jiao (4)"
    property string radical2_word : "比较"
    property string radical2_stroke : "qrc:/gifs/jiao4.gif"
    property double radical2_X : 17.4
    property double radical2_Y : 9.3
    ...
    property bool radical5_correct : true
    property string radical5_character : "校"
    property string radical5_pinyin : "Xiao (4)"
    property string radical5_word : "学校"
    property string radical5_stroke : ""
    property double radical5_X : 23.9
    property double radical5_Y : 9.3
